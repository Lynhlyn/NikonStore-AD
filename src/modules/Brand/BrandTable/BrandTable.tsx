...
const BrandTable = () => {
  ...
  const { data, refetch } = useFetchBrandsQuery({
        ...
        return (
          <div className="flex gap-2 justify-end">
            <Button
              variant="outline"
              size="sm"
              onClick={() => router.push(getRouteWithRole(`/brands/${id}/edit`))}
            >
      ...
      <div className="mb-6">
        <div className="bg-gradient-to-r from-cyan-600 to-cyan-700 rounded-xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-white">Quản lý thương hiệu</h1>
            <Button
              onClick={() => router.push(getRouteWithRole('/brands/new'))}
