...
const CategoryTable = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      <div className="mb-6">
        <div className="bg-gradient-to-r from-teal-600 to-teal-700 rounded-xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className="flex items-center gap-2 bg-white hover:bg-gray-100 text-teal-700 font-medium shadow-sm"
            >
